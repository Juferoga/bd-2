...
CREATE TABLE  BODEGA(
	...
	T_CIUDAD 		VARCHAR(30) NOT NULL,
	K_REGION 		VARCHAR(3) NOT NULL,
	K_PAIS 			VARCHAR(2) NOT NULL,
...
CREATE TABLE  CALISERVICIO(
	...
	T_OBSERVACION	VARCHAR(100) NULL,
...
CREATE TABLE  CATEGORIA(
	K_CATEGORIA 	VARCHAR(3) NOT NULL,
	T_DESCRIPCION 	VARCHAR(30) NOT NULL,
	K_SUPERIOR 		VARCHAR(3) NULL,
	B_ESTADO		char(1) DEFAULT '1',
...
CREATE TABLE  CLASIFICACION(
	K_CLASIFICACION 	VARCHAR(3) NOT NULL,
	T_DESCRIPCION 		VARCHAR(15) NOT NULL,
	N_COMISION			NUMBER(4,3) NOT NULL,

	CONSTRAINT CK_K_CLASIFICACION K_CLASIFICACION (ONOFF in ('b','j','s','m')),
...
CREATE TABLE  METODOPAGO(
	K_METPAGO 		VARCHAR(2) NOT NULL,
	T_DESCRIPCION 	VARCHAR(20) NOT NULL,
	B_ESTADO		char(1) DEFAULT '1',
...
CREATE TABLE  PEDIDO(
	...
	I_ESTADO		VARCHAR(1) NOT NULL,
	N_DIRECCIONE 	VARCHAR(50) NOT NULL,
	K_REGION		VARCHAR(3) NULL,
	K_PAIS 			VARCHAR(2) NULL,
	K_CLIENTE 		NUMBER(10) NULL,
	B_ESTADO		char(1) DEFAULT '1',
	T_CIUDAD	VARCHAR(20) NOT NULL,
...
CREATE TABLE  REPRESENTANTE(
	...
	K_REGION 		VARCHAR(3) NULL,
	K_PAIS 			VARCHAR(2) NULL,
	K_CLASIFICACION VARCHAR(3) NULL,
	K_USUARIO 		NUMBER(10) NULL,
