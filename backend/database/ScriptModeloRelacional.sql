-- TODO: Crear las vistas necesarias para:
-- *    - VIEW Calificación del servicio prestado x representantes
-- *  	- VIEW Estadisticas por representante

DROP TABLE  BODE_PROD ;
DROP TABLE  BODEGA ;
DROP TABLE  CALISERVICIO ;
DROP TABLE  CATEGORIA ;
DROP TABLE  CLASIFICACION ;
DROP TABLE  CLIENTE ;
DROP TABLE  METODOPAGO ;
DROP TABLE  PAGOPEDIDO ;
DROP TABLE  PAIS ;
DROP TABLE  PEDI_ITEM ;
DROP TABLE  PEDIDO ;
DROP TABLE  PRODUCTO ;
DROP TABLE  REGION ;
...
CREATE TABLE  BODE_PROD(
	...
	CONSTRAINT CK_BODE_PROD_B_ESTADO B_ESTADO (ONOFF in ('0','1')),
	CONSTRAINT CK_BODE_PROD_N_CANTIDAD CHECK (N_CANTIDAD >= 0),
...
-- TODO: TRIGGERS PARA CONTROLAR LO REALIZADO EN LA BASE DE DATOS
-- ! 1. Creación de usuarios con tablespace cuando se crea el usuario
-- ! 2. Al momento de crear un pedido crear automaticamente la calificación
-- ! 3. Aumentar la cantidad de productos cuando se agrega un nuevo producto
-- ! 4. Al crear un pedido crear una tupla en pago pedido
-- ! 5. Al realizar una venta (Pago realizado), cambiar el estado a inactivo del producto
-- ! 6. Si se acaban los productos de una bodega pasar la bodega a inactiva
-- ! 7. Esos Por ahora
